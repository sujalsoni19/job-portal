    ...
    <div>
      <Drawer>
        ...
        <DrawerContent>
          ...
          <form  className="px-4 sm:px-8 flex flex-col sm:flex-row gap-3">
            ...
            <Button type="button" onClick={handleSubmit(onsubmit)} variant="blue" >
                Add
            </Button>
          </form>
          {errors.name && (
            ...
            {erroraddCompany?.message && (
                <p className="text-red-500 text-center">{erroraddCompany?.message}</p>
            )}
            {loadingaddCompany && (

...
const schema = z.object({
    experience: z.number().min(0,{message: "Experience must be atleast zero"}).int(),
    skills: z.string().min(1, {message: "Skills are required"}),
    education: z.enum(["intermediate","graduate","postgraduate"],{ message: "Education is required"}),
    resume: z
            .any()
            .refine(
                (file) =>
    ...
    <div>
      <Drawer open={applied ? false : undefined}>
        ...
        <DrawerContent>
          ...
          <form onSubmit={handleSubmit(onformsubmit)} className="px-4 sm:px-8 flex flex-col gap-3">
            ...
            <Input type="text" placeholder="skills(comma separated)" {...register("skills")} />
            {errors.skills && (
